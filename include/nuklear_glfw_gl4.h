...
NK_API void                 nk_glfw3_set_callbacks();
...
{
    glfwSetScrollCallback(glfw.win, nk_gflw3_scroll_callback);
    glfwSetCharCallback(glfw.win, nk_glfw3_char_callback);
    glfwSetMouseButtonCallback(glfw.win, nk_glfw3_mouse_button_callback);
}
