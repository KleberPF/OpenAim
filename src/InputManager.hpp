...
public:
    ...
    static InputManager& instance(); // maybe const this?

    bool isKeyPressed(Key::Value key);
    bool isKeyJustPressed(Key::Value key);

    bool isMouseButtonPressed(MouseButton::Value button);
    bool isMouseButtonJustPressed(MouseButton::Value button);
